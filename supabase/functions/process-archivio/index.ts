...
//
// Estrae testo da PDF/TXT in archivio_documenti, fa chunking semantico,
...
//           sanificazione per code-point (NUL/control/surrogati/zero-width) →
//           niente "unsupported Unicode escape sequence" sull'insert embeddings.
...
// font ritagliati senza tabella ToUnicode (tipico delle norme SIA protette)
