...
import {
  LayoutDashboard, Users, CreditCard, Headphones, User,
  Calendar, Archive, Building2, LogOut, Menu, ChevronRight, Library,
  Search, Sparkles, Plus, HardDrive, AlertTriangle, DraftingCompass
} from 'lucide-react'
...
const NAV = [
  ...
  { path: '/progetti', key: 'progetti', icon: DraftingCompass },
...
export default function ProgettistaLayout({ children }) {
  const { t } = useTranslation('comp_layout_progettista')
