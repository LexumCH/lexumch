// src/components/fiduciario/Imputazioni.jsx
//
// Partita doppia — Fase C: imputazioni automatiche.
// Per ogni categoria di movimento (effettivo) definisci conto contropartita +
// conto cassa/banca + aliquota IVA. Con l'imputazione, i nuovi movimenti
// effettivi generano la scrittura da soli; il bottone "Contabilizza" processa
// quelli già esistenti (storico, OCR) non ancora a mastro.
//
