...
// o a un mandato (fiduciario). Bifronte per ruolo.
//
...
// - role === 'fiduciario' → modalità MANDATO  (tabella mandati,  FK mandato_id)
...
export default function AggiungiAPratica({
    ...
    // Guard ruolo: solo avvocati e fiduciari vedono il bottone
    if (!cfg) return null
