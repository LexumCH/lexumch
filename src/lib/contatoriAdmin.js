...
export const RUOLI = [
  ...
  { id: 'fiduciario',  label: 'Fiduciari',   uno: 'fiduciario',  molti: 'fiduciari',   colorClass: 'text-oro' },
  { id: 'progettista', label: 'Progettisti', uno: 'progettista', molti: 'progettisti', colorClass: 'text-oro' },
...
// "4 professionisti · 5 clienti · 5 user · 2 admin": la composizione del totale
