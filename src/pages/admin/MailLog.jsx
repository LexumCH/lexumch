...
const APP_URL = 'https://www.lexum.ch'
const REPLY_TO = 'info@lexum.ch'
// Il questionario NON esiste ancora su CH: questo ramo resta pronto per
// quando verra' portato, ed e' irraggiungibile finche' l'alias non esiste
// fra i template Postmark del server svizzero.
const ALIAS_QUESTIONARIO = 'lexum-ch-questionario'
const CODICE_QUESTIONARIO = 'feedback_uso_2026'

// I ruoli di CH sono diversi da quelli di IT: qui ci sono fiduciario e
// progettista, non commercialista e commerciale.
const RUOLI = ['user', 'avvocato', 'fiduciario', 'progettista', 'cliente', 'admin']
