// src/pages/fiduciario/BancoLavoro.jsx
//
// Lista di TUTTI i mandati del fiduciario (analoga a AvvocatoPratiche).
// Filtri: ricerca titolo, stato, cliente. Ogni riga linka a /banco-lavoro/:id.
//
// La tabella `mandati` esiste gia: id, titolo, cliente_id, avvocato_id,
// studio_id, tipo, stato (attivo/sospeso/concluso/archiviato), anno_riferimento,
